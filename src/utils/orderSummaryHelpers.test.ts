...
const mockCart1Data: CartItem[] = [
  { selectedDay: 'Monday', meal: { title: 'test1', id: 'x', dishType: DishType.Bowl, price: 5 } },
  {
    selectedDay: 'Monday',
    meal: { title: 'test2', id: 'x', dishType: DishType.Burger, price: 10 },
  },
  {
    selectedDay: 'Friday',
    meal: { title: 'test3', id: 'x', dishType: DishType.Pizza, price: 13.556 },
  },
];
...
describe('calculateAndFormatTotalCartPrice', () => {
  const mockCartData: CartItem[] = [
    {
      selectedDay: 'Monday',
      meal: { title: 'test6', id: 'x', dishType: DishType.Burger, price: 5.554 },
    },
    {
      selectedDay: 'Friday',
      meal: { title: 'test7', id: 'x', dishType: DishType.Pizza, price: 0 },
    },
  ];
...
describe('groupMealByDay', () => {
  const mockCartData: CartItem[] = [
    { selectedDay: 'Monday', meal: { title: 'test5', id: 'x', dishType: DishType.Bowl, price: 5 } },
    {
      selectedDay: 'Sunday',
      meal: { title: 'test5', id: 'x', dishType: DishType.Pasta, price: 5 },
    },
  ];
...
describe('groupMealByDay', () => {
  const mockCartData: CartItem[] = [
    { selectedDay: '', meal: { title: 'test5', id: 'x', dishType: DishType.Bowl, price: 5 } },
    { selectedDay: '', meal: { title: 'test5', id: 'x', dishType: DishType.Pasta, price: 5 } },
  ];
